...
void TIM_debug_handle(TIM_handle_t *htim) {
    printf("htim: %p\n", htim);
    printf("htim->config.timer: %s\n", htim->config.timer == TIM_0 ? "TIM_0" : htim->config.timer == TIM_1 ? "TIM_1"
                                                                                                           : "TIM_2");
    printf("htim->config.preset_value: %d\n", htim->config.preset_value);
    switch (htim->config.clk_source) {
    case TIM_CLK_INTERNAL_PRESCALER_DIV1: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV1\n"); break;
    case TIM_CLK_INTERNAL_PRESCALER_DIV8: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV8\n"); break;
    case TIM_CLK_INTERNAL_PRESCALER_DIV64: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV64\n"); break;
    case TIM_CLK_INTERNAL_PRESCALER_DIV32: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV32\n"); break;
    case TIM_CLK_INTERNAL_PRESCALER_DIV128: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV128\n"); break;
    case TIM_CLK_INTERNAL_PRESCALER_DIV256: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV256\n"); break;
    case TIM_CLK_INTERNAL_PRESCALER_DIV1024: printf("htim->config.clk_source: TIM_CLK_INTERNAL_PRESCALER_DIV1024\n"); break;
    case TIM_CLK_EXTERNAL_FALLING_EDGE: printf("htim->config.clk_source: TIM_CLK_EXTERNAL_FALLING_EDGE\n"); break;
    case TIM_CLK_EXTERNAL_RISING_EDGE: printf("htim->config.clk_source: TIM_CLK_EXTERNAL_RISING_EDGE\n"); break;
    default: printf("htim->config.clk_source: INVALID\n"); break;
    }
    printf("htim->state: %s\n", htim->state == TIM_STATE_READY ? "TIM_STATE_READY" : htim->state == TIM_STATE_BUSY  ? "TIM_STATE_BUSY"
                                                                                 : htim->state == TIM_STATE_TIMEOUT ? "TIM_STATE_TIMEOUT"
                                                                                                                    : "TIM_STATE_MATCH");
    switch (htim->config.mode) {
    case NORMAL_TIMER_AUTORELOAD: printf("htim->config.mode: NORMAL_TIMER_AUTORELOAD\n"); break;
    case NORMAL_ONE_SHOT: printf("htim->config.mode: NORMAL_ONE_SHOT\n"); break;
    case CTC_CHANNEL_A_NO_OUTPUT: printf("htim->config.mode: CTC_CHANNEL_A_NO_OUTPUT\n"); break;
    case CTC_CHANNEL_B_NO_OUTPUT: printf("htim->config.mode: CTC_CHANNEL_B_NO_OUTPUT\n"); break;
    case CTC_CHANNEL_A_PIN_TOGGLE: printf("htim->config.mode: CTC_CHANNEL_A_PIN_TOGGLE\n"); break;
    case CTC_CHANNEL_B_PIN_TOGGLE: printf("htim->config.mode: CTC_CHANNEL_B_PIN_TOGGLE\n"); break;
    case CTC_CHANNEL_A_PIN_CLEAR: printf("htim->config.mode: CTC_CHANNEL_A_PIN_CLEAR\n"); break;
    case CTC_CHANNEL_B_PIN_CLEAR: printf("htim->config.mode: CTC_CHANNEL_B_PIN_CLEAR\n"); break;
    case CTC_CHANNEL_A_PIN_SET: printf("htim->config.mode: CTC_CHANNEL_A_PIN_SET\n"); break;
    case CTC_CHANNEL_B_PIN_SET: printf("htim->config.mode: CTC_CHANNEL_B_PIN_SET\n"); break;
    default: printf("htim->config.mode: INVALID\n"); break;
    }
    printf("htim->is_available: %s\n", htim->is_available ? "true" : "false");
}
#endif